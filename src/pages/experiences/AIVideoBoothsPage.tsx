...
const features = [
  'Neural network video transformation',
  'Stylized motion stories',
  'Brand protagonist narratives',
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Neural networks transform footage into stylized masterpieces, turning guests into protagonists of branded motion stories.
                </p>
              ...
              <div className="relative aspect-square rounded-3xl overflow-hidden glass glow">
                <div className="absolute inset-0 bg-gradient-to-br from-accent/20 via-card to-primary/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <h3 className="font-display text-2xl font-bold text-foreground">Video Magic</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container-custom">
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Let's discuss how AI Video Booths can create stunning motion content for your brand.
              </p>
              <Link to="/contact" className="btn-primary inline-flex items-center gap-2">
