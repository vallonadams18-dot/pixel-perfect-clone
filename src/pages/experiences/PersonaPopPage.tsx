...
const features = [
  'Custom branded trading cards',
  'Data-driven stat generation',
  'Bespoke visual rendering',
  'Instant print & digital delivery',
  'Collectible series support',
  'QR code integration',
];
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Guests capture a portrait; our engine renders a bespoke, data-driven trading card featuring your brand's custom stats.
                </p>
          ...
          <div className="container-custom">
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Let's discuss how Persona Pop can create collectible branded trading cards for your guests.
              </p>
              <Link to="/contact" className="btn-primary inline-flex items-center gap-2">
