...
const features = [
  ...
  'Autonomous guest detection',
  'Studio-quality on-the-go portraits',
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  AXON AI navigates your event using LIDAR, identifying guests to capture high-fidelity, studio-quality portraits.
                </p>
          ...
          <div className="container-custom">
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Let's discuss how AXON AI can autonomously capture stunning portraits at your next event.
              </p>
              <Link to="/contact" className="btn-primary inline-flex items-center gap-2">
