...
const features = [
  'High-fidelity collectible cards',
  'Custom stat generation',
  'Stylized aesthetic rendering',
  'Physical & digital delivery',
  'Series and rarity tiers',
  'NFC/AR integration options',
];
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Transform guests into high-fidelity, branded collectibles featuring custom stats and stylized aesthetics.
                </p>
              ...
              <div className="relative aspect-square rounded-3xl overflow-hidden glass glow">
                <div className="absolute inset-0 bg-gradient-to-br from-accent/20 via-card to-primary/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <h3 className="font-display text-2xl font-bold text-foreground">Collectibles</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container-custom">
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Let's discuss how AI Trading Cards can create unique branded collectibles for your audience.
              </p>
              <Link to="/contact" className="btn-primary inline-flex items-center gap-2">
